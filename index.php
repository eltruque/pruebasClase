...
<body>
    ...
    while (($foto = $dirint->read()) !== false) {
        if ($i > 1) {
            ...
            echo "<img class='bd-placeholder-img' height = '200px' width='200px' src = '$carpeta/$foto' >";
            echo "<input class='form-check-input' name='foto[]' value = 'imagenes/$fotos[$i]' type='checkbox'>";
            echo "</li>";
        }
        $i++;
    }
